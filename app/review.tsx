...
const Review: React.FC<Props> = ({ route }) => {
    ...
    const [editablePollTapeData, setEditablePollTapeData] =
        useState(pollTapeData);
            ...
            setEditablePollTapeData((prev: typeof editablePollTapeData) => {
                try {
                    ...
                    const currentTimestamp = new Date(
                        target[keys[keys.length - 1]] || new Date()
                    );
        ...
        <>
            ...
            <View style={[styles.tighterGroup]}>
                <TextInput
                    ...
                    onEndEditing={(e) =>
                        handleInputSubmit("election_header.type", e.nativeEvent.text)
                    }
                />
                ...
                <Text style={styles.pollTapeText}>
                    {formatDate(editablePollTapeData.election_header.date)}
                </Text>
                <View style={[styles.row]}>
                    ...
                    <TextInput
                        ...
                        onEndEditing={(e) =>
                            handleInputSubmit("election_header.date", e.nativeEvent.text)
                        }
                    />
                </View>
            </View>
            ...
            <View style={[styles.tighterGroup]}>
                <View style={[styles.row]}>
                    <TextInput
                        ...
                        onEndEditing={(e) =>
                            handleInputSubmit(
                                "election_header.location.county",
                                e.nativeEvent.text
                            )
                        }
                    />
                    ...
                    <TextInput
                        ...
                        onEndEditing={(e) =>
                            handleInputSubmit(
                                "election_header.location.state",
                                e.nativeEvent.text
                            )
                        }
                    />
                ...
                <View style={[styles.row]}>
                    <TextInput
                        ...
                        placeholderTextColor="red"
                        defaultValue={
                            editablePollTapeData.election_header.location.precinct.township
                        }
                        onEndEditing={(e) =>
                            handleInputSubmit(
                                "election_header.location.precinct.township",
                                e.nativeEvent.text
                            )
                        }
                    />
                    ...
                    <TextInput
                        ...
                        placeholderTextColor="red"
                        defaultValue={
                            editablePollTapeData.election_header.location.precinct.number
                        }
                        onEndEditing={(e) =>
                            handleInputSubmit(
                                "election_header.location.precinct.number",
                                e.nativeEvent.text
                            )
                        }
                    />
                ...
                <View style={[styles.row]}>
                    <Text style={[styles.pollTapeText, { marginTop: 10 }]}>
                        Election Day Voting
                    </Text>
                </View>
            </View>
            ...
            <View style={styles.tighterGroup}>
                <View style={[styles.row]}>
                    <TextInput
                        ...
                        onEndEditing={(e) =>
                            handleInputSubmit("voting_system.type", e.nativeEvent.text)
                        }
                    />
                </View>
                ...
                <View style={[styles.row]}>
                    ...
                    <TextInput
                        ...
                        onEndEditing={(e) =>
                            handleInputSubmit("voting_system.version", e.nativeEvent.text)
                        }
                    />
                </View>
            </View>
                    ...
                    <>
                        <View style={[styles.row, { marginBottom: 10 }]}>
                            ...
                            <TextInput
                                ...
                                placeholderTextColor="red"
                                defaultValue={
                                    editablePollTapeData.reports.open_polls.counters
                                        .ballot_counter
                                }
                                onEndEditing={(e) =>
                                    handleInputSubmit(
                                        "reports.open_polls.counters.ballot_counter",
                                        e.nativeEvent.text
                                    )
                                }
                            />
                        ...
                        <View style={[styles.row]}>
                            ...
                            <TextInput
                                ...
                                onEndEditing={(e) =>
                                    handleInputSubmit(
                                        "reports.open_polls.counters.lifetime_counter",
                                        e.nativeEvent.text
                                    )
                                }
                            />
                    ...
                    <>
                        <View style={[styles.row, { marginBottom: 10 }]}>
                            ...
                            <TextInput
                                ...
                                placeholderTextColor="red"
                                defaultValue={
                                    editablePollTapeData.reports.closed_polls.counters
                                        .ballot_counter
                                }
                                onEndEditing={(e) =>
                                    handleInputSubmit(
                                        "reports.closed_polls.counters.ballot_counter",
                                        e.nativeEvent.text
                                    )
                                }
                            />
                        ...
                        <View style={[styles.row]}>
                            ...
                            <TextInput
                                ...
                                onEndEditing={(e) =>
                                    handleInputSubmit(
                                        "reports.closed_polls.counters.lifetime_counter",
                                        e.nativeEvent.text
                                    )
                                }
                            />
                        ...
                        {candidate.ticket.map((name, nameIdx) => (
                            <Text
                                ...
                                style={[
                                    styles.pollTapeText,
                                    styles.ticketText,
                                    nameIdx !== candidate.ticket.length - 1 &&
                                    styles.multiTicketText,
                                ]}
                            >
                                {name}
                            </Text>
    ...
    const PrecinctBallotCount: React.FC<{
        ...
        <View style={styles.ballotCountContainer}>
            <Text style={[styles.pollTapeText, { textAlign: "center" }]}>
            ...
            <View style={[styles.rowJustify, styles.dataRow]}>
                <View style={styles.precinctContainer}>
                    <Text style={styles.pollTapeText}>
                        {totals.precinct_ballot_count.precinct.name}
                    </Text>
                </View>
                <TextInput
                    ...
                    onEndEditing={(e) =>
                        handleInputSubmit(
                            "totals.precinct_ballot_count.precinct.total",
                            e.nativeEvent.text
                        )
                    }
                />
            ...
            <View style={[styles.rowJustify, styles.dataRow]}>
                ...
                <TextInput
                    ...
                    onEndEditing={(e) =>
                        handleInputSubmit(
                            "totals.precinct_ballot_count.grand_total",
                            e.nativeEvent.text
                        )
                    }
                />
        ...
        <ScrollView style={styles.container} keyboardShouldPersistTaps="handled">
            <View style={styles.disclaimerContainer}>
                <Text style={styles.disclaimerText}>
                    <Text style={styles.redText}>Red text</Text> indicates no data was scanned.{'\n'}
                    <Text style={styles.blueText}>Blue text</Text> indicates data was scanned but needs review.
                </Text>
            </View>
            <View style={styles.content}>
                ...
                <View style={styles.pollTapeContainer}>
                        ...
                        <View style={[styles.row]}>
                            <TextInput
                                ...
                                defaultValue={formatDateOnly(
                                    editablePollTapeData.reports.open_polls.timestamp
                                )}
                                onEndEditing={(e) =>
                                    handleTimestampUpdate(
                                        "reports.open_polls.timestamp",
                                        "date",
                                        e.nativeEvent.text
                                    )
                                }
                    ...
                    <View style={styles.tighterGroup}>
                        ...
                        <View style={[styles.row]}>
                            <TextInput
                                ...
                                placeholderTextColor="red"
                                defaultValue={formatDateOnly(
                                    editablePollTapeData.reports.closed_polls.timestamp
                                )}
                                onEndEditing={(e) =>
                                    handleTimestampUpdate(
                                        "reports.closed_polls.timestamp",
                                        "date",
                                        e.nativeEvent.text
                                    )
                                }
                    ...
                    <View style={styles.pollTapeHeader}>
                        <Text style={styles.pollTapeHeaderText}>
                    ...
                    <View style={[styles.tighterGroup, styles.rowJustify]}>
                        ...
                        <TextInput
                            ...
                            defaultValue={
                                editablePollTapeData.tally_report.precincts_included
                            }
                            onEndEditing={(e) =>
                                handleInputSubmit(
                                    "tally_report.precincts_included",
                                    e.nativeEvent.text
                                )
                            }
                        />
                    ...
                    {(editablePollTapeData as PollTapeResults).results.contests.map(
                        (contest, index) => (
                            <ContestDisplay
                                key={index}
                                contest={contest}
